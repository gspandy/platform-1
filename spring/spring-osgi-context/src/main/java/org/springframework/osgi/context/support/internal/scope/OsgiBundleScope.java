...
package org.springframework.osgi.context.support.internal.scope;
...
public class OsgiBundleScope implements Scope, DisposableBean {
	...
	/**
	 * ThreadLocal used for passing objects around {@link org.springframework.osgi.context.support.internal.scope.OsgiBundleScope} and
	 * {@link org.springframework.osgi.context.support.internal.scope.OsgiBundleScope.BundleScopeServiceFactory} (there is only one scope instance but
	 * multiple BSSFs).
	 */
