 ...
 * 
 * Can find resources in the <em>bundle jar</em> and <em>bundle space</em>. See {@link org.springframework.osgi.io.OsgiBundleResource} for more
 * information.
 * 
 * <p/> <b>ClassPath support</b>
 * 
 * <p/> As mentioned by {@link org.springframework.core.io.support.PathMatchingResourcePatternResolver}, class-path pattern matching needs to resolve the
...
public class OsgiBundleResourcePatternResolver extends PathMatchingResourcePatternResolver {
	 ...
	 * 
	 * @see org.springframework.osgi.io.OsgiBundleResource#BUNDLE_URL_PREFIX
