 ...
 * <p/>
 * 
 * This classes uses {@link org.springframework.osgi.util.OsgiFilterUtils} underneath to allow multiple class names to be used for service reference
 * lookup.
 * 
 * @see org.springframework.osgi.util.OsgiFilterUtils
 * @author Costin Leau
 * 
 */
public abstract class OsgiServiceReferenceUtils {
	...
	/**
	 * Returns a {@link java.util.Map} containing the properties available for the given service reference. This method takes a
	...
	/**
	 * Returns a {@link java.util.Dictionary} containing the properties available for the given service reference. The returned
	...
	/**
	 * Returns a {@link java.util.Map} containing the properties available for the given service reference. The returned object
	 ...
	 * object that extends {@link java.util.Dictionary} as well as implements the {@link java.util.Map} interface.
	 * 
	 * @param reference OSGi service reference
